	...
	public static void test() {
		...
		WorkHandler<ValueEvent> workHandler = new WorkHandler<ValueEvent>() {
			...
			public void onEvent(ValueEvent event) throws Exception {
				System.out.println(Thread.currentThread().getName() + " , the value is " + event.getValue());
			}
		};
		...
		WorkerPool<ValueEvent> workerPool = new WorkerPool<ValueEvent>(buffer, buffer.newBarrier(),
				new IgnoreExceptionHandler(), workHandler, workHandler, workHandler, workHandler);
