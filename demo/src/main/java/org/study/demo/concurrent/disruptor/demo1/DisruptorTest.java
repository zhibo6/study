...
//		}
//		WorkerPool<IntEvent> crawler = new WorkerPool<IntEvent>(ringBuffer, sequenceBarrier,
...
//		}
//
//		WorkerPool<IntEvent> applier = new WorkerPool<IntEvent>(ringBuffer, sb, new IntEventExceptionHandler(),
//				processors);
