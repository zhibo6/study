...
public class ZxingUtil {
	...
	public static String encode(String content, String imgPath, String destPath)
			throws Exception {
		return ZxingUtil.encode(content, imgPath, destPath, false);
	}
	...
	public static String encode(String content, String destPath,
			boolean needCompress) throws Exception {
		return ZxingUtil.encode(content, null, destPath, needCompress);
	}
	...
	public static String encode(String content, String destPath)
			throws Exception {
		return ZxingUtil.encode(content, null, destPath, false);
	}
...
//		String text = "<OrderResult startdate=\"20050401\" enddate=\"20050401\">" +
//				"<Msg>0</Msg>" +
...
//				"</OrderResult> ";
		String destFileFullPath = ZxingUtil.encode(text, "c:/logo.png",
				"c:/二维码/", true);
